...
urlpatterns = [
    ...
    path('portaria/', views.portaria_list, name='portaria_list'),
    path('portaria/registrar-saida/<int:pk>/', views.portaria_registrar_saida, name='portaria_registrar_saida'),
    path('portaria/registrar-chegada/<int:pk>/', views.portaria_registrar_chegada, name='portaria_registrar_chegada'),
